...
I've converted my earlier glitcherature Python code experiments to a mode for the powerful and easily hackable [Emacs](http://www.gnu.org/software/emacs/tour/) text editor. You can get the code here:
